...
{
    public class HeadPoseCanvasController : MonoBehaviour
    {
        // public attributes
        
        // Pipeline for texture binding
        public DaiHeadPose pipeline;
        
        [Header("UI Binding")] 
        public Image colorCameraImage;
        public TMPro.TextMeshProUGUI headPoseResults;
        ...
        void Update()
        {
            ...
            headPoseResults.text = pipeline.headPoseResults;
        }
    }
}