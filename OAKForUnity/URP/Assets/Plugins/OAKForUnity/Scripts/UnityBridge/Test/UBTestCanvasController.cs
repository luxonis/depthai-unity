...
{
    public class UBTestCanvasController : MonoBehaviour
    {
        // public attributes
        
        // Pipeline for texture binding
        public UBTest pipeline;
        
        [Header("UI Binding")] 
        public Image colorCameraImage;
        public TMPro.TextMeshProUGUI ubTestResults;
        ...
        void Update()
        {
            ...
            ubTestResults.text = pipeline.ubTestResults;
        }
    }
}